...
int main() {
  uint32_t liste_len[10] = {e_len0, e_len1, e_len2, e_len3, e_len4, e_len5, e_len6, e_len7, e_len8, e_len9};
  uint32_t listd_len[10] = {d_len0, d_len1, d_len2, d_len3, d_len4, d_len5, d_len6, d_len7, d_len8, d_len9};
